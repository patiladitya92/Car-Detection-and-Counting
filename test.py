...
stream = CamGear(source='https://www.youtube.com/live/9bFOCNOarrA?si=-Exo7d-gkshx9dn6', stream_mode = True, logging=True).start() # YouTube Video URL as input
...
#################################################################################   
    ...
    cvzone.putTextRect(frame,f'upsidesidelane{caru}',(846,59),1,1)
